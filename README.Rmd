...
**chatLLM** is an R package that provides a unified and flexible interface for interacting with popular Large Language Model (LLM) providers such as **OpenAI**, **Groq**, and **Anthropic**.
...
To get the latest features or bug fixes, you can install the development version of `chatLLM` from GitHub:
...
See the full [function reference](https://knowusuboaky.github.io/chatLLM/reference) or the [package website](https://knowusuboaky.github.io/chatLLM/) for more details.
...
Please open an issue on [GitHub](https://github.com/knowusuboaky/chatLLM/issues) if you run into bugs or have feature requests.
...
Inspired by projects like **RAGFlowChainR** and powered by the R open-source community. Enjoy chatting with your LLMs!
